  ...
  return (
    ...
    >
      ...
      <label className="flex flex-col gap-1.5">
        ...
        <input className="h-8 rounded-md border border-border bg-card px-2.5 text-[0.6875rem] outline-none focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/30" />
      </label>
      <label className="flex flex-col gap-1.5">
